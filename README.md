...
> This version doesn't use any shims or polyfills. If you don't have their substitutes in your projects you may need to use version with the shims [bindcache](https://www.npmjs.com/package/bindcache) instead of this.
